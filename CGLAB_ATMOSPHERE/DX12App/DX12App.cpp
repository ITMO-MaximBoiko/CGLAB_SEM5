...
void DX12App::LoadTextures()
{
	...
	// Skull
	LoadTexture("skull_diffuse", L"../Textures/skull.dds");
	LoadTexture("skull_normals", L"../Textures/skull_nm.dds");
...
void DX12App::BuildShapeGeometry()
{
	...
	allMeshData.push_back( geoGen.LoadModel("..\\Models\\Baryonyx.obj"));	
	allMeshData.push_back(geoGen.LoadModel("Models\\skull.obj"));
...
void DX12App::BuildMaterials()
{
	...
	skull_mat->Name = "skull_mat";
	skull_mat->MatCBIndex = matCBI++;
	skull_mat->DiffuseSrvHeapIndex = mTextures["skull_diffuse"]->SrvHeapIndex;
	skull_mat->NormalSrvHeapIndex = mTextures["skull_normals"]->SrvHeapIndex;
	skull_mat->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	skull_mat->FresnelR0 = XMFLOAT3(0.1f, 0.1f, 0.1f);
	skull_mat->Roughness = 1.0f;

	mMaterials[skull_mat->Name] = std::move(skull_mat);
}
...
void DX12App::BuildRenderItems()
{
	...
	//BuildRenderItem("skull", "skull_mat", XMMatrixTranslation(0., 4., 0.), nullptr);
