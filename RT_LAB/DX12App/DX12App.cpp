...
void DX12App::BuildRenderItems()
{
	...
	//BuildRenderItem("quad", "grassAlpha", XMMatrixRotationX(-XM_PIDIV2)*XMMatrixRotationY(0.6f)*XMMatrixTranslation(0.f, -5.f, -5.f), nullptr, (int)RenderLayer::AlphaTest, 20.0f, 2.0f);

	BuildRenderItem("trex", "trex", XMMatrixTranslation(0., -5.f, 0.), nullptr, 0, 2.f);
...
void DX12App::BuildLightObjects()
{
	...
	point1->Color = { 0.743f, 1.f, 0.41f }; 
	point1->Position = { -15.f, 20.f, 10.f };
