...
const wchar_t* D3D12MeshletRender::c_meshFilename = L"..\\Assets\\generator_new.bin";
const wchar_t* c_texturePath = L"..\\Assets\\generator_diffuse_new.png";
...
void D3D12MeshletRender::OnUpdate()
{
    ...
    XMMATRIX world = XMMatrixScaling(2, 2, 2)* XMMatrixRotationY(0.5 * m_timer.GetTotalSeconds() ) * XMMatrixTranslation(0.0f, 0.0f, 0.0f);
