...
VertexOut VS(VertexIn vin)
{
    ...
    float height = 1.0 - gHeightMap.SampleLevel(gSamLinearClamp, vout.TexC, 0).r;
    ...
    float hL = 1.0 - gHeightMap.SampleLevel(gSamLinearClamp, vout.TexC + float2(-texelSize.x, 0.0f), 0).r;
    float hR = 1.0 - gHeightMap.SampleLevel(gSamLinearClamp, vout.TexC + float2(texelSize.x, 0.0f), 0).r;
    float hD = 1.0 - gHeightMap.SampleLevel(gSamLinearClamp, vout.TexC + float2(0.0f, -texelSize.y), 0).r;
    float hU = 1.0 - gHeightMap.SampleLevel(gSamLinearClamp, vout.TexC + float2(0.0f, texelSize.y), 0).r;
