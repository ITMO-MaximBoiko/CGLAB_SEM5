...
bool CGLAB::Initialize()
{
	...
	m_terrainSystem->Initialize(md3dDevice.Get(), TexOffsets["textures/Canyon_heightmap"],
		1024, 6);
    BuildShapeGeometry();
	SetLightShapes();
...
{
	CreateMaterial("map",0, TexOffsets["textures/Canyon_heightmap"], TexOffsets["textures/Canyon_heightmap"], XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), XMFLOAT3(0.05f, 0.05f, 0.05f), 0.3f);
	CreateMaterial("map2",0, TexOffsets["textures/Canyon_heightmap"], TexOffsets["textures/Canyon_heightmap"], XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), XMFLOAT3(0.05f, 0.05f, 0.05f), 0.3f);

	CreateMaterial("terrainMat", (int)mMaterials.size(),
		TexOffsets["textures/Canyon_diffuse"],
		TexOffsets["textures/Canyon_normal"],
